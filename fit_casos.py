...
# lendo o dataset
data = pd.read_csv("data/tratados/casos_srag_total.csv", sep=",")
...
increasing.to_csv("data/tratados/increasing_casos.csv")
...
decreasing.to_csv("data/tratados/decreasing_casos.csv")
